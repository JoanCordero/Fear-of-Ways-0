...
class juego:
    ...
    def jugar(self):
        ...
        # Activar palancas: al tocarlas se abren puertas con id A1
        ...
        # Verifica si llegó a la salida y tiene llaves suficientes
        llaves_ok = True
        ...
        # HUD de llaves y aviso de salida bloqueada
        if hasattr(self.nivel_actual, "llaves_requeridas"):
